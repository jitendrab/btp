%HMMC2 Train a HMM classifier
%
%   W = HMMC2(A,FRAC,N,REG,MAXITER)
%
% INPUT
%    A      MIL dataset
...
% HMMs. In the training of each HMMs all the sequences in the training
% set are concatenated to one long sequence, and that is trained by the
% HMM.
%
% SEE ALSO
%   HMMC, LABELBAGP
...
function W = hmmc2(a,frac,N,reg,maxiter)
